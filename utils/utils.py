...
def load_corpus(dataset_str,unlabel_size = None):
    """
    Loads input corpus from gcn/data directory

    ind.dataset_str.x => the feature vectors of the training docs as scipy.sparse.csr.csr_matrix object;
    ind.dataset_str.tx => the feature vectors of the test docs as scipy.sparse.csr.csr_matrix object;
    ind.dataset_str.allx => the feature vectors of both labeled and unlabeled training docs/words   #有标签和没标签数据都用上
        (a superset of ind.dataset_str.x) as scipy.sparse.csr.csr_matrix object;
    ...
    if unlabel_size:       
        idx_test = range(allx.shape[0], allx.shape[0] + test_size - unlabel_size)
    else:
